...
WHERE id = $2
RETURNING id, owner, balance, curenccy, created_at
`
...
type CreateAccountParams struct {
	...
	Curenccy string `json:"curenccy"`
}

func (q *Queries) CreateAccount(ctx context.Context, arg CreateAccountParams) (Account, error) {
	row := q.db.QueryRowContext(ctx, createAccount, arg.Owner, arg.Balance, arg.Curenccy)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Owner,
...
SELECT id, owner, balance, curenccy, created_at FROM accounts
WHERE id = $1 LIMIT 1
`
